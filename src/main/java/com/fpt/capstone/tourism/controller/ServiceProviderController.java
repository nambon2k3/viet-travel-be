...
public class ServiceProviderController {
    ...
    @PostMapping
    public ResponseEntity<ServiceProviderDTO> createServiceProvider(@Valid @RequestBody ChangableServiceProviderDTO changableServiceProviderDTO) {
        ServiceProviderDTO createdServiceProvider = serviceProviderService.createServiceProvider(changableServiceProviderDTO);
